...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('painel.chamados.create') }}" class="btn btn-light btn-sm">Abrir Chamado</a>
        </div>
                        ...
                        <tbody>
                            @foreach($chamados as $chamado)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('painel.chamados.show', $chamado->id) }}" class="btn btn-sm btn-outline-primary">Ver</a>
