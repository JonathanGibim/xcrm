...
<body class="d-flex flex-column min-vh-100">
    ...
    <footer class="bg-white border-top py-4 text-center text-muted small">
        <div class="container">
            Projeto livre sob licença MIT. <br>
            Desenvolvido por <strong>Jonathan Gibim</strong> – Agência XWeb • <a href="mailto:jonathangibim@gmail.com">jonathangibim@gmail.com</a>
        </div>
    </footer>
